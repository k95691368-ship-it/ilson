...
// 급한 정도는 shared/urgency.js 가 한 벌로 정한다.
//
// 여기 있었는데, 접기를 넣으면서 화면마다 "이건 접어도 되나"를 각자
// 판단하게 됐다. 그러면 같은 성격의 것이 화면에 따라 접히기도 하고 안
// 접히기도 한다 — 이 저장소가 되풀이 잡아 온 그 모양이다. 밖으로 꺼냈다.
// import 먼저, 그다음 export. `export ... from` 은 이 파일 안에 이름을
// 만들지 않아서, 아래에서 URGENCY 를 쓰면 ReferenceError 가 난다.
// 이 저장소가 실제로 그것으로 신청서 접수를 통째로 500 낸 적이 있다.
